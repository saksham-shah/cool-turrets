...
Entity.prototype.collide = function(other) {
    if (p5.Vector.dist(this.futurePos(), other.pos) <= this.r + other.r) {
        ...
        var newVelX1 = (this.vel.x * (this.mass - other.mass) + (2 * other.mass * other.vel.x)) / (this.mass + other.mass);
        var newVelY1 = (this.vel.y * (this.mass - other.mass) + (2 * other.mass * other.vel.y)) / (this.mass + other.mass);
        var newVelX2 = (other.vel.x * (other.mass - this.mass) + (2 * this.mass * this.vel.x)) / (other.mass + this.mass);
        var newVelY2 = (other.vel.y * (other.mass - this.mass) + (2 * this.mass * this.vel.y)) / (other.mass + this.mass);
        ...
        this.pos.add(p5.Vector.mult(this.vel, dt));
        other.pos.add(p5.Vector.mult(other.vel, dt));
